...
?>  
    ...
    <!-- swiper-slider -->
    <script src="<?="//$url_web/"?>js/plugins/swiper/swiper.js"></script>
    ...
    <!-- signature_pad -->
    <script src="js/plugins/signature_pad.umd.js"></script>
    ...
    <!-- calendar files -->
    <script src="<?="//$url_web/"?>modulos/calendar/js/calendar.js"></script>

    <!-- vue-functions -->
    <!-- <script src="<?="//$url_web/"?>js/vue/vue-functions.js"></script>   -->

    <!-- java-script files -->
    <script src="<?="//$url_web/"?>js/functions-ad72411ad9.js"></script>

    <!-- select 2 files -->
    <script src="<?="//$url_web/"?>js/plugins/select2/select2.js"></script>

    <!-- fancybox -->
    <script src="https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js"></script>

    <script async="false" type="text/javascript"
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB746M-UYhU-vNSsWPNHt-3x37afH9nvvM&&libraries=placescallback=initMap">
    </script>

    <!-- snackbar -->
    <script src="<?="//$url_web/"?>js/plugins/snackbar.js"></script>
